...
- **Opening a card brings its column with it.** The panel opens over the right of the screen, which is where the column you were working in usually is — so the point of a side panel, seeing the board while you read a card, was lost on exactly the card you had just clicked. The board now slides across just far enough to leave that column beside the panel, and stays put when the column was already clear or the window is too narrow for the move to help.
